...
<body>
    ...
    <div class="paragraph">
        ...
        @else
            of legal age, 
        @endif
        is a permanent resident of Barangay Pasig, Kiblawan, Davao del Sur, 
        and whose signature and thumbmark appear hereon.
    </div>

    <div class="paragraph">
        This is to certify further that based on the records of this office, the subject person 
        has <strong>NO DEROGATORY RECORD</strong> and is known to be of good moral character, peace-loving, 
        and a law-abiding citizen within this community.
    </div>

    <div class="paragraph">
        This clearance is being issued upon the request of the above-named person for 
        <strong>{{ $documentRequest->purpose }}</strong> and is valid for six (6) months from the date of issuance.
    </div>
    ...
    <!-- Clearance Details / Tracking Info -->
            ...
            <td>
                <div class="signature-container">
                    @php
                        ...
                        $punongBarangayName = '';
                        if ($signatory) {
                            $punongBarangayName = $signatory->full_name;
                        }
